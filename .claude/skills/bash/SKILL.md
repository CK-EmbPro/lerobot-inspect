...
> **Quick reference:** for a fast lookup of everyday Bash/Linux commands and
> idioms (operators, file/process/text ops, env vars, network, cleanup traps,
> `awk` float math, Bash-vs-PowerShell), see
> [`references/linux-patterns.md`](references/linux-patterns.md). This SKILL.md
> governs *how to structure scripts*; that file is the command cheat-sheet.
